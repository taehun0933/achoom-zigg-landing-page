...
const OnboardingScreen: React.FC = () => {
  return (
    <div className="relative w-full pt-[90px] flex flex-col items-center px-9">
      <div className="flex flex-col max-w-[600px] mb-4">
        <img
          src="/images/mobile/onboardingLogo.png"
          alt="background"
          className="transition-all duration-500 w-[200px] sm:w-[250px] md:w-[300px]"
        />
        ...
        <div className="relative flex w-full max-w-[500px] mt-2 gap-2 justify-end">
          <img
            src="/images/googlePlay.png"
            alt="googlePlay"
            className="w-28 md:w-32 pointer-events-auto cursor-pointer hover:scale-[102%]"
            onClick={() => {
              window.open(
          ...
          <img
            ...
            alt="appStore"
            className="w-24 sm:w-28 md:w-32 pointer-events-auto cursor-pointer hover:scale-[102%]"
            onClick={() => {
              window.open(
